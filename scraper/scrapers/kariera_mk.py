...
class KarieraMkScraper(BaseScraper):
    ...
    def scrape(self) -> List[ScrapedJob]:
        ...
        urls_to_scrape = [
            self.base_url,
            "https://kariera.mk/oglasi",
            "https://kariera.mk/administracija",
            "https://kariera.mk/rabota-vo-stranstvo"
        ]
        ...
        try:
            for scrape_url in urls_to_scrape:
                ...
                logger.info(f"Found {len(job_elements)} job elements on {scrape_url}", source=self.source_name)
                    ...
                    try:
                        ...
                        if title_text and company_text and url:
                            jobs.append(ScrapedJob(
                                ...
                                is_remote="remote" in title_text.lower() or "remote" in location_text.lower() or "stranstvo" in scrape_url.lower()
                            ))
